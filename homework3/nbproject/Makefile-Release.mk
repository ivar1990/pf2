...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/homework3.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/homework3 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/homework3.o: homework3.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/homework3.o homework3.cpp
